...
public class KafkaGuidelineConfig {
    ...
    @Bean
    public ConsumerFactory<String, GuidelineRequest> guidelineDTOConsumerFactory() {
        Map<String, Object> config = new HashMap();
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(GuidelineRequest.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, GuidelineRequest> guidelineKafkaListenerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, GuidelineRequest> factory = new ConcurrentKafkaListenerContainerFactory<>();
